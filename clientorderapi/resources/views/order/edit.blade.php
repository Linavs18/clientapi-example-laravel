        ...
        <form action="{{ route('order.update', $order['order']) }}" method="post">
            ...
            <div class="row form-group">
                <div class="col-lg-6 mb-4">
                    ...
                    <input type="date" class="form-control" name="legalization_date" id="legalization_date" required value="{{ $order['order']['legalization_date'] }}">
                </div>
                <div class="col-lg-6 mb-4">
                    <label for="address">Dirección</label>
                    <input type="text" class="form-control" name="address" id="address" required value="{{ $order['order']['address'] }}">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-lg-4 mb-4">
                    <label for="city">Ciudad</label>
                    <select name="city" id="city" class="form-control" value="{{ $order['order']['city'] }}">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <select name="causal_id" id="causal_id" class="form-control" required value="{{ $order['order']['causal_id'] }}">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <select name="observation_id" id="observation_id" class="form-control" value="{{ $order['order']['observation_id'] }}">
                        <option value="">Seleccione</option>
                            ...
                            <table id="table_data_added" class="table table-striped table-hover">
                                ...
                                @else 
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $activity['hours'] }}</td>
                                        <td>
                                            <a href="{{ route('order.remove_activity', [$order['order']['id'], $activity['id']])}}" class="btn btn-danger btn-circle btn-sm" title="Agregar">
